        ...
        <div class="mt-24 flex h-full w-full flex-col items-center justify-between rounded-md">
            <div class="mt-5 flex h-auto w-full flex-col items-center justify-center">
                <h1
                    ...
                    Meet our Team</h1>
                <p class="mt-2 w-[40vw] text-center text-xs text-dark sm:text-sm md:text-base lg:text-xl">
                    Get to know Group G from the Integrasi Aplikasi Korporasi SD-A1 course!
                </p>
            </div>
