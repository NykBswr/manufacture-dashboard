        ...
        <div class="mt-24 flex h-full w-full flex-col items-center justify-between rounded-md">
            <div class="mt-5 flex h-auto w-full flex-col items-center justify-center">
                <h1
                    ...
                    Meet our Team</h1>
                <p class="mt-2 w-[38vw] text-center text-xs text-dark sm:text-sm md:text-base lg:text-lg">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque venenatis massa quis metus mollis
                    mollis nec venenatis lorem. Phasellus vestibulum dictum nisl. Nullam quis fermentum erat.
                </p>
            </div>
            ...
            <div class="flex h-full w-full items-center justify-between pt-10">
                ...
                <div class="flex h-full w-full items-center justify-between pt-10">
                    ...
                    <!-- Card 1 -->
                    <div class="group flex h-auto w-[17.8vw] items-end rounded-md bg-gray-100 shadow-lg hover:z-10">
                        ...
                        <div
                            ...
                            <p class="text-dark">16211210xx</p>
                        </div>
                    </div>

                    <!-- Card 2 -->
                    <div class="group flex h-auto w-[17.5vw] items-end rounded-md bg-gray-100 shadow-lg hover:z-10">
                        <img class="img h-full w-full rounded-md grayscale transition duration-300 group-hover:grayscale-0"
                            src="{{ asset('img/nyk.png') }}" alt="Nayaka Baswara">
                        <div
                            class="absolute z-[1] mb-4 ml-4 h-auto w-[14.5vw] rounded bg-white px-3 py-2 text-justify text-dark shadow">
                    ...
                    <div id="card-3"
                        class="card-3 flex h-auto w-[17vw] items-end rounded-md bg-gray-100 shadow-lg hover:z-10">
                        <img id="img-3" class="img h-full w-full rounded-md grayscale-0 transition duration-300"
                            src="{{ asset('img/nyk.png') }}" alt="Nayaka Baswara">
                        <div
                            class="absolute z-[1] mb-4 ml-4 h-auto w-[14.5vw] rounded bg-white px-3 py-2 text-justify text-dark shadow">
                            <h3 class="text-sm font-bold md:text-base lg:text-lg">Nayaka Baswara</h3>
                            <p class="text-dark">1621121065</p>
                        </div>
                    </div>

                    <!-- Card 4 -->
                    <div class="group2 group flex h-auto w-[17.5vw] items-end rounded-md bg-gray-100 shadow-lg hover:z-10">
                        <img class="img h-full w-full rounded-md grayscale transition duration-300 group-hover:grayscale-0"
                            src="{{ asset('img/nyk.png') }}" alt="Nayaka Baswara">
                        <div
                            class="absolute z-[1] mb-4 ml-4 h-auto w-[14.5vw] rounded bg-white px-3 py-2 text-justify text-dark shadow">
                    ...
                    <!-- Card 5 -->
                    <div class="group2 group flex h-auto w-[17.8vw] items-end rounded-md bg-gray-100 shadow-lg hover:z-10">
                        <img class="img h-full w-full rounded-md grayscale transition duration-300 group-hover:grayscale-0"
                            src="{{ asset('img/nyk.png') }}" alt="Nayaka Baswara">
                        <div
                            class="absolute z-[1] mb-4 ml-4 h-auto w-[14.5vw] rounded bg-white px-3 py-2 text-justify text-dark shadow">
